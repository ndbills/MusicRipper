  ...
  <Grid Margin="12">
    ...
    <DataGrid Grid.Row="2" x:Name="TracksGrid"
      ...
      <DataGrid.Columns>
        ...
        <DataGridTextColumn Header="Title"  Binding="{Binding Title,  UpdateSourceTrigger=LostFocus}" Width="*"/>
        <DataGridTextColumn Header="Artist" Binding="{Binding Artist, UpdateSourceTrigger=LostFocus}" Width="240"/>
